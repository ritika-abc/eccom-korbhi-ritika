...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a href="index3.php" class="brand-link bg-white">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2 my-5">
          ...
          <!-- Services -->
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item <?php if ($url == "/ecommerce_website/admin/add-product.php" || $url == "/ecommerce_website/admin/view-product.php") {
                                  echo "menu-open";
                                } ?>">
              <a href="#" class="nav-link <?php if ($url == "/ecommerce_website/admin/add-product.php" || $url == "/ecommerce_website/admin/view-product.php") {
                                            echo "active";
                                          } ?>">
                <i class="nav-icon fas fa-tachometer-alt"></i>
                <p>
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="view-product.php" class="nav-link <?php if ($url == "/ecommerce_website/admin/view-product.php") {
                                                                echo "active";
                                                              } ?>">
                    <i class="far fa-circle nav-icon"></i>
